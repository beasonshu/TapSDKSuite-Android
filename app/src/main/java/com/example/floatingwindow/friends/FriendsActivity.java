...
public class FriendsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FacebookSdk.setApplicationId("117461515644116");
        ...
        findViewById(R.id.init_cn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TapConfig tdsConfig = new TapConfig.Builder()
                        ...
                        .withClientId(isRND ? "uZ8Yy6cSXVOR6AMRPj" : "0RiAlMny7jiz086FaU")
                        .withClientToken(isRND ? "AVhR1Bu9qfLR1cGbZMAdZ5rzJSxfoEiQaFf1T2P7" : "8V8wemqkpkxmAN7qKhvlh6v0pXc8JJzEZe3JFUnU")
                        .withServerUrl(isRND ? "https://api.leancloud.cn" : "https://0rialmny.cloud.tds1.tapapis.cn")
        ...
        findViewById(R.id.init_io).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TapConfig tdsConfig = new TapConfig.Builder()
                        .withAppContext(FriendsActivity.this)
                        .withTapDBConfig(tapDBConfig)
                        .withClientId(isRND ? "" : "bAbz5vh3Ey6hleydQPsqzX2E-i82VnK8M")
                        .withClientToken(isRND ? "" : "BIJYojCy9B2p6PY3PpILQJAR")
                        .withServerUrl("https://bAbz5vh3.cloud.ap-sg.tapapis.com")
